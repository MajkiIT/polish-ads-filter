...
Nano Defender | pułapki typu anty-adblock, skrypty nie przyjazne użytkownikom i inne | [Sprawdź](https://github.com/MajkiIT/polish-ads-filter/blob/master/nano_defender/readme.md) | | ![uBO][uBO] ![NANO][NANO]
